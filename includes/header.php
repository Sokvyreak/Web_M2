<?php
define("APPURL","https://raven-intense-supposedly.ngrok-free.app/freshcery%20-%20Online");
define("IMGURLCAT","../../img_category/");
define("IMGURLPRO","../../img_product/");
session_start();
...
<head>
    ...
    <link rel="icon" href="<?php echo APPURL;?>/assets/img/logo/logo-white.png">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarcollapse">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item">
                            <a href="<?php echo APPURL?>/shop.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF'])== 'shop.php'?'active' : ''?>">Shop</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo APPURL;?>/faq.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF'])== 'faq.php'?'active' : ''?>">FAQ</a>
                        </li>
                        <?php if(!isset($_SESSION['username'])) : ?>
                        <li class="nav-item">
                            <a href="<?php echo APPURL;?>/auth/register.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF'])== 'register.php'?'active' : ''?>">Register</a>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo APPURL;?>/auth/login.php" class="nav-link <?php echo basename($_SERVER['PHP_SELF'])== 'login.php'?'active' : ''?>">Login</a>
                        </li>
                        <?php else : ?>
