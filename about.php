        ...
        <section class="bg-leaf">
            <div class="container">
                ...
                <div class="row justify-content-center align-items-center mt-3">
                    <div class="col-md-4">
                        <img src="<?php echo IMGURLCAT;?>fruits.jpg" class="img-fluid">
                    </div>
                    <div class="col-md-6">
                        <h5>
                ...
                <div class="row justify-content-center align-items-center text-right mt-3">
                    ...
                    <div class="col-md-4">
                        <img src="<?php echo IMGURLCAT;?>vegetables.jpg" class="img-fluid">
                    </div>
                </div>

                <div class="row justify-content-center align-items-center mt-3">
                    <div class="col-md-4">
                        <img src="<?php echo IMGURLCAT;?>fish.jpg" class="img-fluid">
                    </div>
                    <div class="col-md-6">
                        <h5>
